...
export class VideoController {
  ...
  static confirm = catchAsync(async (req: Request, res: Response) => 
  res.json(await VideoService.confirmUpload(req.params.id as string))
);
  static delete = catchAsync(async (req: Request, res: Response) => 
  res.json(await VideoService.delete(req.params.id as string, req.user!.sub, req.user!.role))
);}